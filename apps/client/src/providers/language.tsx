...
const EN = {
    ...
    "RadioGroup": {
        ...
        "yes": "Yes",
        "no": "No",
        'نعم التكلفة التقديرية أقل من 100 مليون': 'Yes, the estimated cost is less than 100 million.',
        'لا  التكلفة التقديرية أعلى من 100 مليون': 'No, the estimated cost is more than 100 million.',
        'نعم. تنطبق على آلية وزن المحتوى الوطني': 'Yes. It applies to the national content weighting mechanism.',
        'لا تنطبق آلية وزن المحتوى المحلي في التقييم المالي أو آلية الحد الأدنى المطلوب للمحتوى المحلي على العقد.': 'No. It does not apply to the local content weighting mechanism.'
    },
    "DynamicTable": {
        "Total": "Total",
        "Tax": "Tax",
...
const AR = {
    ...
    "NavHeader": {
        "create": "إنشاء الكراسة",
        "update": "تعديل الكراسة",
        "tasks": "مهام الكراسة",
        "view": "عرض الكراسة",
        "perform": "تنفيذ مهمة الكراسة",
    ...
    "CreateUpdataBookletForm": {
        ...
        "projectName": "اسم المنافسة",
        "bookletNumber": "رقم النموذج",
        "issueDate": "تاريخ طرح الكراسة",
        "issueDay": "اليوم",
    ...
    "RadioGroup": {
        ...
        "yes": "نعم",
        "no": "لا",
        'نعم التكلفة التقديرية أقل من 100 مليون': 'نعم التكلفة التقديرية أقل من 100 مليون',
        'لا  التكلفة التقديرية أعلى من 100 مليون': 'لا  التكلفة التقديرية أعلى من 100 مليون',
        'نعم. تنطبق على آلية وزن المحتوى الوطني': 'نعم. تنطبق على آلية وزن المحتوى الوطني',
        'لا تنطبق آلية وزن المحتوى المحلي في التقييم المالي أو آلية الحد الأدنى المطلوب للمحتوى المحلي على العقد.': 'لا تنطبق آلية وزن المحتوى المحلي في التقييم المالي أو آلية الحد الأدنى المطلوب للمحتوى المحلي على العقد.'
    },
    "DynamicTable": {
