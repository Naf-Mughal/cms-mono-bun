...
export const bookletSchema = z.object({
    ...
    governmentName: z.string({ required_error: "Government Name is required" }),
    departmentName: z.string({ required_error: "Department Name is required" }),
    formName: z.string({ required_error: "Form Name is required" }),
    revision: z.string({ required_error: "Revision Number is required" }),
    revisionDate: z.string({ required_error: "Revision Date is required" }),
