import { DynamicTableFooterLabelsEnum } from "@schemas/index"
        ...
        <div className="container max-w-5xl">
            <div className="flex flex-col gap-4">
                {data?.tables?.map((table) => (
                    <div key={table?.id} className="border-0 shadow-none py-4 px-2">
                                            ...
                                            {footerLabels?.map((label, index) => (
                                                <tr key={`footer-${index}`}>
                                                    <td className="p-2 border font-medium text-right w-7/10">
                                                        {DynamicTableFooterLabelsEnum[label as keyof typeof DynamicTableFooterLabelsEnum]}
                                                    </td>
                                ...
                                <thead>
                                    <tr>
                                        <th colSpan={2} className="p-3 border text-center font-bold text-lg">
                                            {DynamicTableFooterLabelsEnum["Summary of All Tables"]}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td className="p-2 border font-medium text-right" style={{ width: "70%" }}>
                                            {DynamicTableFooterLabelsEnum.Total}
                                        </td>
                                    ...
                                    <tr>
                                        <td className="p-2 border font-medium text-right" style={{ width: "70%" }}>
                                            {DynamicTableFooterLabelsEnum.Tax}
                                        </td>
                                        <td className="p-2 border text-right font-bold" style={{ width: "30%" }}>
                                    ...
                                    <tr>
                                        <td className="p-2 border font-medium text-right" style={{ width: "70%" }}>
                                            {DynamicTableFooterLabelsEnum["Grand Total"]}
                                        </td>
                                        <td className="p-2 border text-right font-bold" style={{ width: "30%" }}>
